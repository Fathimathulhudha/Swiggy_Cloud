...
import pizza from "../../assets/Add/pizza.png";
import pizza1 from "../../assets/Add/pizza1.png";
import pizza3 from "../../assets/Add/pizza3.png";
import pizza4 from "../../assets/Add/pizza4.png";
import pizza5 from "../../assets/Add/pizza5.png";
...
"Pizza topped with our herb-infused signature pan sauce and mozzarella cheese. A classic treat for all cheese lovers out there",
    ...
    },
    {
      ...
      description:
" supreme combination of black olives, green capsicum, mushroom, onion, spicy red paprika & juicy sweet corn with flavourful pan sauce and mozzarella cheese",
      size: "1 kg",
      calories: 4000,
    },
    {
      ...
      price: 320,
      img: pizza4,
      ingredients: ["crunchy onion"],
      description:
"It's our signature. Spiced paneer, crunchy onions & green capsicum, spicy red paprika with delicious tandoori sauce and mozzarella cheese",
      size: "1 kg",
      calories: 4200,
    },
    {
      ...
      description:
"Herbed onion and green capsicum, juicy sweet corn & mozzarella cheese with flavourful pan sauce",      size: "1 cup",
      calories: 600,
    },
  ];
