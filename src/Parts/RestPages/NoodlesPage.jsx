...
import noodd  from "../../assets/Add/noodd.png";
import dry from "../../assets/Add/dry.png";
import dry2 from "../../assets/Add/dry2.png";
import cheesy  from "../../assets/Add/cheesy.png";
...
export default function NoodlesPage() {
  ...
  const recommendedFoods = [
    {
      id: 1,
      name: "The Great Khali Thali Veg",
      price: 299,
      img: dry,
      ingredients: ["Chocolate Sponge", "Cherries", "Whipped Cream"],
      description:
"Introducing the freshly launched Great Khali Veg Thali (10 Items).",
    },
    {
      id: 2,
      name: "The Great Khali Thali Non-Veg",
      price: 350,
      img: dry2,
      ingredients: ["thali"],
      description:
"Introducing the freshly launched Great Khali Non Veg Thali (10 Items)",
    },
    {
      id: 3,
      name: "Chinese Bhel Tangy Tangra Style",
      price: 129,
      img: cheesy,
      ingredients: ["cheesy"],
      description:
      "Fried noodles mixed with bell peppers, tangy, and spicy bhel sauce",
    },
    {
      id: 4,
      ...
      ingredients: ["butter"],
      description:
"Diced fish wok tossed in delicious butter garlic sauce",
    },
  ];
